...
class MagnumCog(BaseCog):
    def __init__(self, bot):
        super().__init__(
            ...
            name="Magnum",
            nickname="Magnum",
            trigger_words=['magnum', 'magnum hi'],
            model="anthracite-org/magnum-v4-72b",  # Keeping the model line as instructed
    ...
    async def on_message(self, message):
        ...
        if self.context_cog:
            try:
                ...
                logging.error(f"[Magnum] Failed to add message to context: {str(e)}")

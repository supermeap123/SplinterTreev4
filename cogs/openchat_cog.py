...
class OpenChatCog(BaseCog):
    def __init__(self, bot):
        super().__init__(
            ...
            name="OpenChat",
            nickname="OpenChat",
            trigger_words=['openchat', 'openchat hi'],
            model="openchat/openchat-7b:free",  # Keeping the model line as instructed
    ...
    async def on_message(self, message):
        ...
        if self.context_cog:
            try:
                ...
                logging.error(f"[OpenChat] Failed to add message to context: {str(e)}")
